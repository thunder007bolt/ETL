...
DIM_CONFIG = [
    ...
    },
    {
        ...
        "target":    "DIM_CATEGORIE_EMPLOYEUR",
    ...
    },
    {
        ...
        "target":    "DIM_CATEGORIE_DOSSIER_PENSION",
    ...
    },
    {
        ...
        "target":    "DIM_CATEGORIE_PRESTATION_NAT",
        "key_cols":  ["CPN_CODE"],
        # "strategy":  "gtt",
    ...
    },
    {
        ...
        "target":    "DIM_DIRECTION_REGIONALE",
        "key_cols":  ["DR_NO"],
        "strategy":  "gtt",
    ...
    },
    {
        ...
        "target":    "DIM_INSTITUTION_FINANCIERE",
        "key_cols":  ["IF_NO"],
        "strategy":  "gtt",
    ...
    },
    {
        ...
        "target":    "DIM_LIEU_PAIEMENT",
        "key_cols":  ["LP_NO"],
    },
    {
        "sql_file":  "param_caisse_rep_dec.sql",
        "target":    "DIM_PARAM_CAISSE_REC_DEP",
        "key_cols":  ["CODE_CAISSE"],
    },
    {
        "sql_file":  "param_cpt_bancaire.sql",
        "target":    "DIM_PARAM_CPT_BANCAIRE",
    ...
    },
    {
        ...
        "target":    "DIM_PARAMETRES_COTISATION",
    ...
    },
    {
        ...
        "target":    "DIM_SECTEUR_ACTIVITE",
        "key_cols":  ["SA_NO"],
    },
    {
        "sql_file":  "secteur_operation.sql",
        "target":    "DIM_SECTEUR_OPERATION",
    ...
    },
    {
        ...
        "target":    "DIM_SERVICE_PROVINCIAL",
        "key_cols":  ["SP_NO"],
    },
    {
        "sql_file":  "tranche_effectif.sql",
        "target":    "DIM_TRANCHE_EFFECTIF",
        "key_cols":  ["TEF_CODE"],
    },
    {
        "sql_file":  "trimestre.sql",
        "target":    "DIM_TRIMESTRE",
        "key_cols":  ["TRIM_ID"],
    },
]
