...
SELECT
    ...
    CASE WHEN e.EMP_REGIME = 'M' THEN NVL(e.SA_NO, 99) END AS SA_NO_2,
    dp.ID_PERIODICITE             AS ID_PERIODICITE,
    e.EMP_ETAT                    AS EMP_ETAT,
    tef.TEF_CODE                  AS TEF_CODE,
    CASE WHEN e.EMP_REGIME = 'M' THEN tef.TEF_CODE END AS TEF_CODE_2,
...
GROUP BY
    ...
    e.EMP_REGIME,
    NVL(e.SA_NO, 99),
    CASE WHEN e.EMP_REGIME = 'M' THEN NVL(e.SA_NO, 99) END,
    dp.ID_PERIODICITE,
    e.EMP_ETAT,
    tef.TEF_CODE,
    CASE WHEN e.EMP_REGIME = 'M' THEN tef.TEF_CODE END,
    fj.FJ_CODE,
    fj.FJ_CODE_SUP,
