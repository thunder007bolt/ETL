...
-- R3      : délai NAT (M)    = DEB_DATE_APPROBATION - DEB_DATE_INSERT     (>= 2017-01-01)
...
-- Filtre DEB_TYPE='RB' : uniquement remboursements maternité
premier_deb_nat AS (
    SELECT deb.DOS_CODE,
...
base AS (
    ...
    FROM (SELECT DISTINCT DOS_CODE FROM DWH.FAIT_DEBOURS WHERE CLICHE = :1) deb
