...
SELECT
    ...
    CASE
        ...
        ELSE CASE
            WHEN TRUNC(MONTHS_BETWEEN(TO_DATE('3112'||TO_CHAR(EXTRACT(YEAR FROM b.DEB_DATE_EFFET)),'DDMMYYYY'),b.IND_DATE_NAISSANCE)/12) < 20 THEN '<20'
            WHEN TRUNC(MONTHS_BETWEEN(TO_DATE('3112'||TO_CHAR(EXTRACT(YEAR FROM b.DEB_DATE_EFFET)),'DDMMYYYY'),b.IND_DATE_NAISSANCE)/12) < 25 THEN '20-24'
            WHEN TRUNC(MONTHS_BETWEEN(TO_DATE('3112'||TO_CHAR(EXTRACT(YEAR FROM b.DEB_DATE_EFFET)),'DDMMYYYY'),b.IND_DATE_NAISSANCE)/12) < 30 THEN '25-29'
            WHEN TRUNC(MONTHS_BETWEEN(TO_DATE('3112'||TO_CHAR(EXTRACT(YEAR FROM b.DEB_DATE_EFFET)),'DDMMYYYY'),b.IND_DATE_NAISSANCE)/12) < 35 THEN '30-34'
            WHEN TRUNC(MONTHS_BETWEEN(TO_DATE('3112'||TO_CHAR(EXTRACT(YEAR FROM b.DEB_DATE_EFFET)),'DDMMYYYY'),b.IND_DATE_NAISSANCE)/12) < 40 THEN '35-39'
            WHEN TRUNC(MONTHS_BETWEEN(TO_DATE('3112'||TO_CHAR(EXTRACT(YEAR FROM b.DEB_DATE_EFFET)),'DDMMYYYY'),b.IND_DATE_NAISSANCE)/12) < 45 THEN '40-44'
            WHEN TRUNC(MONTHS_BETWEEN(TO_DATE('3112'||TO_CHAR(EXTRACT(YEAR FROM b.DEB_DATE_EFFET)),'DDMMYYYY'),b.IND_DATE_NAISSANCE)/12) < 50 THEN '45-49'
            WHEN TRUNC(MONTHS_BETWEEN(TO_DATE('3112'||TO_CHAR(EXTRACT(YEAR FROM b.DEB_DATE_EFFET)),'DDMMYYYY'),b.IND_DATE_NAISSANCE)/12) < 55 THEN '50-54'
            WHEN TRUNC(MONTHS_BETWEEN(TO_DATE('3112'||TO_CHAR(EXTRACT(YEAR FROM b.DEB_DATE_EFFET)),'DDMMYYYY'),b.IND_DATE_NAISSANCE)/12) < 60 THEN '55-59'
            WHEN TRUNC(MONTHS_BETWEEN(TO_DATE('3112'||TO_CHAR(EXTRACT(YEAR FROM b.DEB_DATE_EFFET)),'DDMMYYYY'),b.IND_DATE_NAISSANCE)/12) < 65 THEN '60-64'
            WHEN TRUNC(MONTHS_BETWEEN(TO_DATE('3112'||TO_CHAR(EXTRACT(YEAR FROM b.DEB_DATE_EFFET)),'DDMMYYYY'),b.IND_DATE_NAISSANCE)/12) < 70 THEN '65-69'
            WHEN TRUNC(MONTHS_BETWEEN(TO_DATE('3112'||TO_CHAR(EXTRACT(YEAR FROM b.DEB_DATE_EFFET)),'DDMMYYYY'),b.IND_DATE_NAISSANCE)/12) < 75 THEN '70-74'
            WHEN TRUNC(MONTHS_BETWEEN(TO_DATE('3112'||TO_CHAR(EXTRACT(YEAR FROM b.DEB_DATE_EFFET)),'DDMMYYYY'),b.IND_DATE_NAISSANCE)/12) < 80 THEN '75-79'
            ELSE '80+'
        END
    END                                                             AS TRANCHE_AGE,
    -- ── MESURES ─────────────────────────────────────────────────────
